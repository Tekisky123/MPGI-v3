...
const getDepartmentName = (collegeId: string | undefined, departmentSlug: string): string => {
    if (!collegeId) return departmentSlug;
    const collegeKey = Object.keys(collegeConfigs).find(
        key => collegeConfigs[key as keyof typeof collegeConfigs].slug === collegeId
    );
    if (!collegeKey) return departmentSlug;
    const department = collegeConfigs[collegeKey as keyof typeof collegeConfigs].departments.find(
        d => d.slug === departmentSlug
    );
    return department?.displayName || departmentSlug;
};
                    ...
                    <div className="bg-mpgin-darkBlue text-white py-16 md:py-24">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8">
                            ...
                            <p className="text-lg md:text-xl max-w-3xl">
                                Meet our accomplished academic mentors and industry experts
                            </p>
                        </div>
                    </div>
                </motion.div>
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-gray-600 font-medium">
                                                {getDepartmentName(collegeId, selectedMember.department)}
                                            </p>
                                        </div>
            ...
            <div className="flex-1">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                    <p className="text-gray-500 text-sm font-medium">
                        {getDepartmentName(collegeId, member.department)}
                    </p>
