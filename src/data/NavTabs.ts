export const NAV_ITEMS = [
...

  {
    ...
    subItems: [
      { name: "CESA", path: "/activities/cesa" },
      { name: "CUC", path: "/activities/cuc" },
      { name: "ETA", path: "/activities/eta" },
      { name: "CSI/IEI", path: "/activities/csi" },
      ...
      { name: "Jhankaar", path: "/activities/jhankaar" },
    ],
  },
